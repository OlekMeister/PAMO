...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction bottomNavigationItemView = onView(
                allOf(withId(R.id.nav_bmi), withContentDescription("BMI"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.buttonCalculate), withText("Oblicz"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.fragment_container),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewResult), withText("Twoje BMI to: 23.5"),
                        withParent(withParent(withId(R.id.fragment_container))),
                        isDisplayed()));
        textView.check(matches(withText("Twoje BMI to: 23.5")));
    }
